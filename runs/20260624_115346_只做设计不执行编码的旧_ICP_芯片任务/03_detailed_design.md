# 详细设计：只做设计不执行编码的旧 ICP 芯片任务

| dd_id | linked_arch | file | operation | symbols | verification_point |
| --- | --- | --- | --- | --- | --- |
| DD1 | A1 | src/common/config_8bit.h | 新增 #define VMODEL_TEST_8BIT，并添加 STR_VMODEL_TEST_8BIT。 | VMODEL_TEST_8BIT, STR_VMODEL_TEST_8BIT | 宏可被 Select-String 检索到。 |
